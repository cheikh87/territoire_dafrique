...
if($type==="*")
$sql = "SELECT nom,type,etat, public.ST_AsGeoJSON(public.ST_Transform((shape),4326),2) AS geojson from infrastructures_up where up=".$up."";

else	
$sql = "SELECT nom,type,etat, public.ST_AsGeoJSON(public.ST_Transform((shape),4326),2) AS geojson from infrastructures_up where up=".$up." and type='".$type."'";
